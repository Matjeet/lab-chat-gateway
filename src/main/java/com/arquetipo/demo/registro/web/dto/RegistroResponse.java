...
/**
 * DTO de salida tras registrar un usuario, tal como lo devuelve {@code chat-registro}. No
 * expone la contrasena ni ningun identificador propio del proveedor de identidad (UID).
 */
